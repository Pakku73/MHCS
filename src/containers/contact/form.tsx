...
export const Form = () => {
  return (
    <>
      ...
      <section className="flex flex-col relative items-center justify-center mb-[100px] h-svh bg-cover bg-no-repeat bg-center bg-[url('../../../public/assets/images/contact-hero-banner.jpg')]">
        <div className="space-y-6 flex max-w-3xl flex-col items-center justify-center">
          <div className="bg-[#ada796]  rounded-[10px] py-2 z-10">
            <div className="relative w-fit mt-4 mx-auto">
              <img
                className="absolute -top-3 -right-4"
                src="../../../public/assets/icons/mail-white.svg"
                alt=""
              />
              <h1 className="uppercase font-ChangeOne text-white text-[40px]">
                Contactez-nous
              </h1>
            </div>
            <p className="text-[#f2ead5] text-center text-[18px]">
              Nos équipes vous contactent sous 48 heures !
            </p>
            ...
            <div className="flex flex-col items-center justify-center mt-6 gap-6 max-w-full">
              ...
              <p className="flex items-center justify-center px-20 text-white text-[18px]">
                Vos informations saisies dans ce formulaire sont traitées avec
                confidentialité et resteront strictement confidentielles.
              </p>
              <div className="flex z-15 justify-center items-center gap-10 font-ChangeOne">
                <button className="bg-[#000000] text-[#f2ead5] p-2 rounded-[6px] border-[1px] border-black hover:bg-[#f2ead5] hover:text-black transition ease-in-out duration-300  hover:-translate-y-2 shadow-md uppercase">
                  Envoyer
                </button>
              </div>
            </div>
          ...
          <div className="flex w-full items-center justify-center bg-white z-20  rounded-[10px] py-5 px-6 text-[18px] gap-4">
            <img src="../../../public/assets/icons/contact-popup.svg" alt="" />
            <p className="text-sm">
