...
export const Form = () => {
    return <>
      ...
      <section className="flex flex-col items-center justify-center mb-[100px]">
          ...
          <div className="flex flex-col items-center justify-center absolute max-w-[600px] mt-60 bg-[#ada796] rounded-[10px] py-2 z-10 xl:max-w-[900px]">
        ...
        <div className="flex items-center justify-center absolute translate-y-[500px] bg-white z-20 max-w-[900px] rounded-[10px] py-5 px-6 text-[18px] gap-4 xl:translate-y-[290px]">
