...
export const Form = () => {
    return <>
      ...
      <section className="flex flex-col items-center justify-center mb-[100px]">
          ...
          <div className="flex flex-col items-center justify-center absolute bg-[#ada796] rounded-[10px] py-10 z-10">
        ...
        <div className="flex flex-col items-center justify-center absolute bg-white">
          <p>Ou contactez-nous directement par téléphone <span>07.72.50.38.81</span> ou par mail <span>secretariat@mhcsparis.com.</span></p>
        </div>
  
        <div>
          <div className="absolute z-0 top-0 left-0 w-full h-full bg-[#00000073]"></div> 
