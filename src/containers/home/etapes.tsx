      ...
      <div className="flex flex-col items-center gap-14">
        ...
        <div className="flex flex-col gap-14 items-center max-w-screen-2xl xl:flex-row">
          <div className="flex flex-col bg-[#dedad2] max-w-[330px] rounded-[6px] items-center p-4 shadow-md">
            ...
            <img
              className="max-w-40"
              src="../../../public/assets/icons/contact.png"
              alt=""
            />
            <p className="text-center">
              Je prends contact via le formulaire de contact sur le site
              internet ou j’appelle directement le 07.72.50.38.81.
            </p>
          </div>
          ...
          <div className="flex flex-col bg-[#dedad2] max-w-[330px] rounded-[6px] items-center p-4 shadow-md">
            ...
            <img
              className="max-w-40"
              src="../../../public/assets/icons/expert-rdv.png"
              alt=""
            />
            <p className="text-center">
              La prise de rendez-vous sera faite suite aux échanges entre vous
              et nos équipes, selon vos besoins et votre calendrier.
            </p>
          </div>
          ...
          <div className="flex flex-col bg-[#dedad2] max-w-[330px] rounded-[6px] items-center p-4 shadow-md">
            ...
            <img
              className="max-w-40"
              src="../../../public/assets/icons/souscription.png"
              alt=""
            />
            <p className="text-center">
              Suite à notre premier rendez-vous, nous établissons ensemble une
              offre parfaitement adaptée à votre établissement.
            </p>
          </div>
          ...
          <div className="flex flex-col bg-[#f2ead5] max-w-[330px] rounded-[6px] items-center p-4 border-[1px] border-[#bfbcb5] shadow-md">
            ...
            <img
              className="max-w-40"
              src="../../../public/assets/icons/service.png"
              alt=""
            />
            <p className="text-center">
              Je prends contact via le formulaire de contact sur le site
            ...
            <p className="text-center text-[14px] mt-1">
              (commissions de sécurité, contrôles périodiques obligatoires,
              garantie des contrôles obligatoires en vigueur selon le type de
              bâtiment)
            </p>
        ...
        <button className="bg-[#000000] font-ChangeOne text-[#f2ead5] p-2 rounded-[2px] hover:bg-[#f2ead5] transition ease-in-out duration-300 hover:text-[#000000] hover:-translate-y-2">
          Prendre rendez-vous
        </button>
      </div>
    </Section>
