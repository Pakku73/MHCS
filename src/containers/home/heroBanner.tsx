      ...
      <div className="relative h-full flex justify-center items-center">
        <div className="flex flex-col justify-center items-center z-15 h-full w-full">
          ...
          <div className="flex z-10 justify-center items-center gap-10 font-ChangeOne">
            ...
            <button className="bg-[#ada796] text-white p-2 rounded-[2px] hover:bg-[#ffffff] hover:text-[#ada796] transition ease-in-out duration-300  hover:-translate-y-2 shadow-md">
