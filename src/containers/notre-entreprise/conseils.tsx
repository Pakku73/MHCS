        ...
        <div className="flex flex-col bg-[#ffffff] shadow-md p-10 px-[100px] rounded-[6px]">
            ...
            <div className="flex gap-36">
                ...
                <div className="flex flex-col text-[#000000] justify-center">
                    <h2 className="flex flex-col font-ChangeOne text-[500] text-[30px] text-start w-[600px]">
                ...
                <img className="rounded-[6px]" src="../../../public/assets/images/advice-section-image.jpg" alt="" />
